...
export default function AdminScreen() {
  ...
  const toggleMenu = () => {
    translateX.value = withTiming(menuOpen ? -MENU_WIDTH : 0, {
      duration: 250,
    });
        ...
        return (
          <TableOrdersScreen
            onEditPedido={(id) => {
              ...
              setCurrentScreen("editOrder");
            }}
          />
        );
      case "editOrder":
        return editingPedidoId ? (
          <EditOrderScreen
            pedidoId={editingPedidoId}
            onClose={() => {
              setEditingPedidoId(null);
              setCurrentScreen("tableOrders");
            }}
          />
        ) : null;
      default:
  ...
  return (
    ...
    >
      <TouchableWithoutFeedback
        disabled={!menuOpen}
        onPress={menuOpen ? toggleMenu : undefined}
      >
        <View style={{ flex: 1 }}>
        ...
        >
          <View className="items-center mb-8 mt-12">
            <Image
              ...
              resizeMode="contain"
            />
            <Text className="text-primary-color text-heading-xl font-bold mt-2">
              MOTA
            </Text>
          </View>
          ...
          <View className="space-y-1">
            ...
            <MenuItem
              icon={
                <MaterialCommunityIcons name="file-refresh-outline" size={20} />
              }
              label="A corrección"
