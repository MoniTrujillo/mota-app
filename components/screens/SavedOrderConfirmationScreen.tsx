      ...
      >
        ...
        <View className="w-full px-1">
          <Text className="text-title-color text-base leading-[20px] text-justify mb-6">
            Se ha registrado correctamente el pedido. Si todo es correcto, darle a enviar para ser confirmado por el solicitante y el cliente, al momento de ser confirmado, solo se podrá modificar el status del pago.
          </Text>
