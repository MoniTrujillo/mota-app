...
export default function CreateOrdersScreen() {
  ...
  // Productos dinámicos - precio se obtiene del backend por id
            ...
            setTelefonoCliente(
              formatTelefonoMX(
                (data as any).telefono ||
                  (data as any).telefono_consultorio ||
                  ""
              )
            );
          }
  ...
  const funcionNameByKey: Record<
    ...
    string
  > = {
    cliente: "medico", // ahora 'cliente' busca función 'medico'
    dado: "dado",
    disenador: "disenador",
    fresadora: "fresadora",
  };
  ...
  > = {
    ...
    fresadora: 4,
    dado: 5,
    cliente: 1, // fallback para médicos
  };
    ...
    <SafeAreaView className="flex-1 bg-background-color">
      ...
      >
        ...
        >
          ...
          <Text className="text-title-color text-2xl font-bold mb-6">
            Nuevo pedido
          </Text>
              ...
              <View key={idx} className="mb-2">
                ...
                <View className="flex-row items-center justify-between mb-2">
                  ...
                  {idx > 0 && (
                    ...
                    >
                      <Text className="text-title-color text-xs font-bold">
                        Borrar
                      </Text>
                    </TouchableOpacity>
                  )}
        ...
        {/* Modal: Fecha de entrega (solo iOS) */}
        {Platform.OS === "ios" && (
          <Modal
